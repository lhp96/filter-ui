const enSidebar = {
  "/en-US/": [
    { text: "Quick Start", link: "/en-US/" },
    {
      text: "JavaScript",
      children: [
        { text: "base", link: "/en-US/JavaScript/base/", status: "completed" },
      ],
    },
    {
      text: "General",
      children: [
        ...
        {
          text: "Panel",
          link: "/en-US/components/panel/",
          status: "completed",
        },
        {
          text: "Search",
          link: "/en-US/components/search/",
          status: "completed",
        },
        {
          text: "Status",
          link: "/en-US/components/status/",
          status: "completed",
        },
    ...
    },
    {
      ...
      children: [
        ...
        { text: "InputNumber", link: "/en-US/components/input-number/" },
        {
          ...
          link: "/en-US/components/multi-auto-complete/",
        },
        {
          text: "Radio",
        ...
        {
          text: "TagInput",
          link: "/en-US/components/tag-input/",
          status: "completed",
        },
    ...
    },
    {
      ...
      children: [
        ...
        {
          text: "QuadrantDiagram",
          link: "/en-US/components/quadrant-diagram/",
        },
